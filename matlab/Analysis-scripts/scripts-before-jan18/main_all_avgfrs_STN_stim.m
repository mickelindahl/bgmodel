...
function [] = main_all_avgfrs_STN_stim()
data_dir = [pwd,'/Sensory-resp-STN-amp200-4000-10/'];%mat_data/'];
...
stimtimes = stimvars.CS.start_times;
stimrate = stimvars.CS.rates;
STids = stimvars.CS.stim_subpop;
STall = stimvars.CS.allpop;
