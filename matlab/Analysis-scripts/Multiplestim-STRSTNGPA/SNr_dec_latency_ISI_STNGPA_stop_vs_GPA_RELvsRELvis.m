...
function [] = SNr_dec_latency_ISI_STNGPA_stop_vs_GPA_RELvsRELvis(data_dir,GPA_stop_dir,fig_dir)
%     warning('off')
...
%     GPA_stop_dir = '/space2/mohaghegh-data/Working-Directory/PhD/Projects/BGmodel/MATLAB-data-analysis/Analysis/Gostop-avgfrs-STN-1000-2000-STR-400-2000-reltime--130-20/';
    ...
    fig_dir = [fig_dir,'latency-comparison-ISI-20-vs-GPA-RELvsREL/',nuclei{nc_id},'/'];
