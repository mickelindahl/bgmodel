...
function [] = SNr_dec_latency_ISI_STNGPA_stop_vs_STN_RELvsRELvis_STNREL(data_dir,STN_stop_dir,fig_dir)
%     warning('off')
...
%     STN_stop_dir = '/space2/mohaghegh-data/Working-Directory/PhD/Projects/BGmodel/MATLAB-data-analysis/Analysis/Gostop-avgfrs-STN-1000-2000-STR-400-2000-reltime--130-20/';
    nc_id = 1;
    ...
    fig_dir = [fig_dir,'latency-comparison-ISI-20-vs-STN-RELvsREL-RELSTN/',nuclei{nc_id},'/'];
...
%     t_vec = t_vec(t_vec >= start_search_time);
    ...
    rel_reltime = rel_reltime(rel_reltime>=0);
...
%     SNr_fr_th = 2;                  % Threshold for the SNr movement trigger
    ...
    %                                              Percent
                ...
                ylabel('Time to sensory stim in STN (ms)')
        ...
        save([fig_dir,'latency-var-peakth','-widthth',num2str(width_th)],...
             ...
             'params_stngpa','params_stn','num_mov_str','num_mov','num_mov_str_stn','num_mov_stn','rel_reltime')
end
