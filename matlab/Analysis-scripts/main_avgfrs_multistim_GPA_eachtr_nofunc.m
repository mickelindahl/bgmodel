...
% function [] = main_avgfrs_multistim_eachtr(data_dir,res_dir)
%     data_dir = '/space2/mohaghegh-data/temp-storage/18-01-19-gostop+GPA/all-in-one/';
    data_dir = '/home/mohaghegh-data/temp-storage/18-02-14-gostop+GPA-longsensorystim-gGPASTR-increased/W-20/all-in-one-numtr20/';
    res_dir = '/home/mohaghegh-data/temp-storage/18-02-14-gostop+GPA-longsensorystim-gGPASTR-increased/W-20/';
    if isempty(data_dir)
...
%         clear data
        ...
        for gpaf_ind = 1:length(gpa_f)
            ...
            for stnf_ind = 1:length(stn_f)
                ...
                h_sim_time = max(stimtimes(stimrate_sel(2,:) == stn_f(stnf_ind)));
                l_sim_time = min(stimtimes(stimrate_sel(2,:) == stn_f(stnf_ind)));
                ...
                for rel_time_ind = 1:length(str_stn_lat)
                    ...
                    sel_stimtimes = stimtimes(...
                                    stimrate(4,:) == str_stn_lat(rel_time_ind) & ...
