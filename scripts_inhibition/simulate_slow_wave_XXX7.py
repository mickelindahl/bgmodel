...
def perturbations():
    ...
    l+=[pl({'nest':{'GA_M1_gaba':{'weight':0.2},
                    ...
                    'ST_GA_ampa':{'weight':0.2},
                    'GA_GA_gaba':{'weight':0.2},
                    'GI_GA_gaba':{'weight':0.2}
                    }},
           '*',
            **{'name':'weight0.2-EA300'})]  
    l[-1]+=pl({
              'node':{'C1':{'rate':560.0},
                      'C2':{'rate':700.0},
                      'EA':{'rate':300.0}}},
    ...
    l+=[pl({'nest':{'GA_M1_gaba':{'weight':0.35},
                    'GA_M2_gaba':{'weight':0.35},
