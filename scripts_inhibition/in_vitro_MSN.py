...
labels=['MSN_D1-dop','MSN_D2-dop', 'MSN_D1-no_dop','MSN_D2-no_dop', 
        'MSN_D1-dop-C_m', 'MSN_D1-dop-V_t', 'MSN_D1-dop-C_m_V_t']
...
inv.simulate_IF(1, numpy.arange(150, 300,10), labels[0:4], 5000.0)   
inv.simulate_IF_variation(1, numpy.arange(150, 300,10), [labels[4]], 5000.0, 10, ['C_m'])
inv.simulate_IF_variation(1, numpy.arange(150, 300,10), [labels[5]], 5000.0, 10, ['V_th'])
inv.simulate_IF_variation(1, numpy.arange(150, 300,10), [labels[6]], 5000.0, 10, ['C_m', 'V_th'])
inv.show(labels)
pylab.show()
