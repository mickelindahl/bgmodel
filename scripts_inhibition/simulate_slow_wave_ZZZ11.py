...
import sys
import oscillation_perturbations11 as op
import pprint
pp=pprint.pprint


path_rate_runs=get_path_rate_runs('simulate_inhibition_ZZZ11/')
...
amp_base=numpy.arange(0.7, 1.3, 0.05)
freqs=numpy.arange(0.25, 1.5, 0.25)
n=len(amp_base)
m=len(freqs)
