...
#            +'milner/simulate_beta_ZZZ41_slow/'
#            +'script_0054_exc1.0_EIEACS_600.0_STGAw_0.1875_GAGA_10.0_GIGA_20.0-amp_0.16_1.1_stn_3.0')
# #            +'script_0029_exc1.0_EIEACS_600.0_STGAw_0.1875_GAGA_5.0_GIGA_25.0-amp_0.16_1.05_stn_3.0')
# setup=simulate_beta.Setup(20,1)
# plot(file_name, figs, setup, 'beta')


file_name=('/home/mikael/results/papers/inhibition/network/'
           +'milner/simulate_slow_wave_ZZZ411_slow_sw/'
           +'script_0004_exc0.65_EIEACS_600.0_STGAw_0.1875_GAGA_5.0_GIGA_25.0-amp_0.13-0.85')
