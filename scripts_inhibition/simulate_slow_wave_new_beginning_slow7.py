...
path_rate_runs=get_path_rate_runs('simulate_inhibition_new_beginning_slow7/')
...
amp_base=[0.85, 0.9, 0.95] #numpy.arange(1.05, 1.2, 0.05)
...
loop(60,[num_sims,num_sims,num_sims/2], a_list, k_list )
