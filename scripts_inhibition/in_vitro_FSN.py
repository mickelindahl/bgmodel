...
labels=['FSN-dop','FSN-no_dop', 
        'FSN-dop-C_m', 'FSN-dop-V_t',
        'FSN-dop-C_m_V_t']
tata_dop=[0.8,0.0, 
          0.8,0.8,0.8]
...
inv.simulate_IF_variation(1, numpy.arange(0, 300,30), [labels[2]], 5000.0, 10, ['C_m'])
inv.simulate_IF_variation(1, numpy.arange(0, 300,30), [labels[3]], 5000.0, 10, ['V_th'])
inv.simulate_IF_variation(1, numpy.arange(0, 300,30), [labels[4]], 5000.0, 10, ['C_m', 'V_th'])
inv.show(labels)
pylab.show()
