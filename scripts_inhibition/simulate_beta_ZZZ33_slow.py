...
import oscillation_perturbations33_slow as op
import pprint
pp=pprint.pprint

path_rate_runs=get_path_rate_runs('simulate_inhibition_ZZZ33_slow/')
...
amp_base=numpy.arange(1.05, 1.2, 0.05)
freqs=numpy.arange(0.4, 1.0, 0.3)
n=len(amp_base)
m=len(freqs)
