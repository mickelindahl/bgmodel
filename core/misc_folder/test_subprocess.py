...
@author: mikael
'''
path='/home/mikael/git/bgmodel/core/misc_folder/test_subprocess/'
from toolbox.data_to_disk import pickle_save

import subprocess


from core.misc_folder import test_subprocess_fun
