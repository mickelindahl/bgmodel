...
from scripts_inhibition import neuron 
...
#         self.curve_uv_extreme_point = w.plot(x,y, pen=pen)
        ...
        self.p2.param('IV, IF, nullcline, etc', 'run neuron').sigActivated.connect(self.run_neuron_thread)
...
#             'V_a':self.V_a,
#             'V_th':self.V_th}
#         from toolbox import my_population
...
#         main(*args, **kwargs)
        neuron.main(from_disk=from_disk,
               kw=kw,
               net='Net_0',
               script_name=script_name,
               setup=neuron.Setup(50,20) )
