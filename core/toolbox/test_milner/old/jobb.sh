...
#SBATCH -e /home/mikael/tmp/do_unittest/err
#SBATCH -o /home/mikael/tmp/do_unittest/out
...
aprun -n 20 python milner_test_simulation 2>&1 | tee delme_milner_test_simulation.txt