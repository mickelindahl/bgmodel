...
#     
    iterator = ([[slice(2,4), i] for i in range(0,4)]+
                [[slice(5,7), i] for i in range(0,4)]+
                [[slice(8,10), i] for i in range(0,4)]+
                [[slice(11,13), i] for i in range(0,4)]+
                [[slice(14,16), i] for i in range(0,4)]+
                [[slice(17,19), i] for i in range(0,4)]+
                [[slice(20,22), i] for i in range(0,4)]
...
# add_to_files(files, paths[1], nets2,  **{'names':['no_dop']})
# add_to_files(files, paths[2], ['Net_1'], **{'names':['normal']})

# 
# s1='script_0000_GAGA_25.0_GIGA_5.0-ss-1.0'
# s2='script_0000_GAGA_20.0_GIGA_10.0-ss-1.0'
# 
...
#          ['CTX_M2','Net_0'],
#          ['MS_MS','Net_0'],
#          ['M2_M2_pert_0.2', 'Net_0'],
#          ['ST_GA_pert_2.6', 'Net_0'],
#          ['ST_GI_pert_0.2', 'Net_0'],
#          ['M2_GI_pert_0.2', 'Net_0'],
#          ['M2_GI_pert_2.6', 'Net_0'],
#          ['GI_ST_pert_2.6', 'Net_0'],
#          ['M1_pert_mod7', 'Net_0'],
#          ['M2_pert_mod0', 'Net_0'],       
#          ['ST_pert_mod7', 'Net_0']]
...
builder=[
        ['Control', 'Net_0'],
         ['FS_M2_pert_5', 'Net_0'],
         ['GA_FS_pert_5','Net_0'],
         ['GA_M2_pert_0.0','Net_0'],
         ['GA_M2_pert_5', 'Net_0'],
         ['GI_GA_pert_0.0', 'Net_0'],
         ['GI_GI_pert_0.0', 'Net_0'],
         ['GI_ST_pert_5', 'Net_0'],
         ['GI_pert_mod0', 'Net_0'],
         ['GI_pert_mod7', 'Net_0'],
         ['M1_pert_mod7', 'Net_0'],
         ['M2_GI_pert_0.0', 'Net_0'],
         ['M2_GI_pert_5','Net_0'],
         ['M2_M2_pert_5', 'Net_0'],
         ['M2_pert_mod7', 'Net_0'],  
         ['MS_MS', 'Net_0'],
         ['SN_pert_mod0', 'Net_0'],
         ['ST_GA_pert_0.0', 'Net_0'],
         ['ST_GA_pert_5', 'Net_0'],
         ['ST_GI_pert_0.0', 'Net_0'],
         ['ST_pert_mod7', 'Net_0']
#          ['M2_pert_mod0', 'Net_0'],       
#          ['ST_pert_mod7', 'Net_0']
         ]
...
fig, axs=ps.get_figure2(n_rows=22, 
                        n_cols=4,
                        w=9/37.*72/2.54*17.6*2*scale,
                        h=9/37.*72/2.54*17.6*4*scale,  
                        fontsize=7*scale,
