...
import eNeuro_rev_full_FSr_v2_pert as op
import pprint
import fig_defaults as fd
pp=pprint.pprint

path_rate_runs=get_path_rate_runs('eNeuro_rev_full_FSr_v2_sim_inh/')
...
amp_base=[fd.amp_beta-0.05,fd.amp_beta-0.025,  fd.amp_beta, fd.amp_beta+0.025] #numpy.arange(1.05, 1.2, 0.05)
