...
import oscillation_perturbations15 as op
import pprint
pp=pprint.pprint

path_rate_runs=get_path_rate_runs('simulate_inhibition_ZZZ15/')
...
amp_base=[1.] #[umpy.arange(0.7, 1.3, 0.05)
