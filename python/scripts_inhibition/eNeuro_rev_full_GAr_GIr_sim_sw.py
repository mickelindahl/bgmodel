...
import eNeuro_rev_full_GAr_GIr_pert as op
import pprint
pp=pprint.pprint

path_rate_runs=get_path_rate_runs('eNeuro_rev_full_GAr_GIr_sim_inh/')
...
amp_base=[fd.amp_sw, 0.875] #numpy.arange(1.05, 1.2, 0.05)
freqs=[ 0.3, 0.4, 0.5, 0.6] #numpy.arange(0.5, .8, 0.2)
ops=op.get()['sw']
n=len(amp_base)
m=len(freqs)
