...
# from core.network.manager import Builder_single_M1_weights as Builder
# 
# import pprint
# pp=pprint.pprint
...
def main(rand_nodes=False, 
    ...
    print dinfo['opt_rate']
    pp(dn['opt_rate']['Net_0'].par['conn'])
    ds = get_storages(script_name, dn.keys(), dinfo)
  
    d={}
    d.update(optimize('opt_rate', dn, [from_disk]*5, ds, **{'verbose':True,
                                                             'x0':700.0}))   
