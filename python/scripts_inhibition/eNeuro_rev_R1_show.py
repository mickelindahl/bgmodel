...
path=[
    ('/home/mikael/results/papers/inhibition/network/'
           +'milner/eNeuro_rev_R1_1i_sim_beta/'),
    ('/home/mikael/results/papers/inhibition/network/'
           +'milner/eNeuro_rev_R1_1i_no_osc_M2_sim_beta/'),
    ('/home/mikael/results/papers/inhibition/network/'
           +'milner/eNeuro_rev_R1_1i_no_osc_MS_sim_beta/'),
    ('/home/mikael/results/papers/inhibition/network/'
           +'milner/eNeuro_rev_R1_1ii_sim_beta/'),
    ('/home/mikael/results/papers/inhibition/network/'
           +'milner/eNeuro_rev_R1_1ii_no_osc_STN_sim_beta/'),
]
