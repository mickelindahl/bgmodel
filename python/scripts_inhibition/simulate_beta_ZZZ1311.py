...
from core.network.manager import Builder_beta_EI_EA as Builder
from core.parallel_excecution import loop

import numpy
import sys
import scripts_inhibition.base_oscillation_beta as module
import oscillation_perturbations131 as op
import pprint
pp=pprint.pprint

path_rate_runs=get_path_rate_runs('simulate_inhibition_ZZZ131/')
...
amp_base=[1.15]#numpy.arange(0.9, 1.25, 0.05)
freqs=[0.8]#numpy.arange(0.3, 1.5, 0.1)
n=len(amp_base)
m=len(freqs)
