...
import eNeuro_rev_full_explore_v7_pert as op
import pprint
pp=pprint.pprint

path_rate_runs=get_path_rate_runs('eNeuro_rev_full_explore_v7_sim_inh/')
...
amp_base=[fd.amp_sw - 0.04, fd.amp_sw - 0.03, fd.amp_sw - 0.02, 
          fd.amp_sw - 0.01, fd.amp_sw] #numpy.arange(1.05, 1.2, 0.05)
freqs=[ 0.5, 0.6, 0.7] #numpy.arange(0.5, .8, 0.2)
ops=op.get()['sw']
n=len(amp_base)
m=len(freqs)
