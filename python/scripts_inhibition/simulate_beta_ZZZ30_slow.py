...
import oscillation_perturbations30_slow as op
import pprint
pp=pprint.pprint

path_rate_runs=get_path_rate_runs('simulate_inhibition_ZZZ30_slow/')
...
amp_base=numpy.arange(1.0, 1.2, 0.05)
freqs=numpy.arange(0.1, 1.0, 0.2)
n=len(amp_base)
m=len(freqs)
