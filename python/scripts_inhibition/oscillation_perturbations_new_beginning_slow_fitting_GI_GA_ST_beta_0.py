...
#     misc.dict_update(solution, {'equal':{'node':{'M2p':{'rate':2.9}}}})
    ...
    '''
    misc.dict_update(solution, {'equal':{'node':{'CS':{'rate':280-90}}}})
    misc.dict_update(solution, {'equal':{'nest':{'ST_GA_ampa':{'weight':0.259}}}})
    misc.dict_update(solution, {'equal':{'node':{'EA':{'rate':0.}}}})
    misc.dict_update(solution, {'equal':{'node':{'EI':{'rate':1500.0}}}})
