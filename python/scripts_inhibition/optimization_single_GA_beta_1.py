...
import oscillation_perturbations_new_beginning_slow_fitting_beta_GA_1 as op
import pprint
pp=pprint.pprint
...
#         'no_oscillations_control':True,
         'opt':[{'Net_1':{'f':['GA'],
                         ...
                         'x0':[0.45]}}]*n_ops, #Same size as ops
...
#         'path_rate_runs':path_rate_runs,
        ...
        'sim_time':40000.0,
        'single_unit':['GA']*n_ops, #Same size as ops
        'size':1.0 ,
#         'STN_amp_mod':STN_amp_mod,
        
        'tp_names':['beta']*n_ops, #Same size as ops
