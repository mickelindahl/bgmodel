...
import eNeuro_rev_full_explore_v3_pert as op
import pprint
import fig_defaults as fd
pp=pprint.pprint

path_rate_runs=get_path_rate_runs('eNeuro_rev_full_explore_v3_sim_inh/')
...
amp_base=[ fd.amp_beta, fd.amp_beta + 0.025, fd.amp_beta + 0.05, fd.amp_beta + 0.075 ,fd.amp_beta + 0.1 ] #numpy.arange(1.05, 1.2, 0.05)
freqs=[ 0.5, 0.7, 0.9] #numpy.arange(0.5, .8, 0.2)
ops=op.get()['beta']
n=len(amp_base)
m=len(freqs)
