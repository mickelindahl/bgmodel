...
class EneuroParBase( object ):
    def _get_par_constant(self):
        ...
        dic['nest']['FS_FS_gaba']['type_id'] = 'static_synapse'
        ...
        dic['nest']['FS_M1_gaba']['type_id'] = 'static_synapse'
        ...
        dic['nest']['M2_GI_gaba']['type_id'] = 'static_synapse'
        ...
        dic['nest']['M2_GA_gaba']['type_id'] = 'static_synapse'
        ...
        dic['nest']['M1_SN_gaba']['type_id'] = 'static_synapse'
        ...
        dic['nest']['ST_SN_ampa']['type_id'] = 'static_synapse'
        ...
        dic['nest']['GI_SN_gaba']['type_id'] = 'static_synapse'
        ...
        dic['nest']['MS']['GABAA_1_Tau_decay'] = 8.0 #GetNest('FS_M1_gaba', 'tau_psc')
        ...
        dic['nest']['FS']['GABAA_1_Tau_decay'] = 6. #GetNest('FS_FS_gaba', 'tau_psc')
        ...
        dic['nest']['GI']['GABAA_1_Tau_decay'] = 6. #GetNest('M2_GI_gaba', 'tau_psc')  # (Shen et al. 2008)
        ...
        dic['nest']['SN']['GABAA_1_Tau_decay'] = 5.2 #GetNest('M1_SN_gaba', 'tau_psc')  # (Connelly et al. 2010)
        dic['nest']['SN']['beta_I_GABAA_1'] = 0.56  # 0.8 # From MSN D1

        # GPe-SNr
        dic['nest']['SN']['GABAA_2_E_rev'] = -72.  # (Connelly et al. 2010)
        dic['nest']['SN']['GABAA_2_Tau_decay'] = 2.1#  GetNest('GI_SN_gaba', 'tau_psc')
