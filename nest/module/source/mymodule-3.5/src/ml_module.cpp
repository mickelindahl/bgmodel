...
/*
 * There are three scenarios, in which MLModule can be loaded by NEST:
 *
...
mynest::MLModule ml_module_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::MLModule::MLModule()
{
#ifdef LINKED_MODULE
...
mynest::MLModule::~MLModule() = default;

const std::string
mynest::MLModule::name() const
{
...
void
mynest::MLModule::init( SLIInterpreter* i )
{
