...
inline
nest::port mynest::izhik_cond_exp::handles_test_event(nest::CurrentEvent&, nest::rport receptor_type)
{
  if ( receptor_type < MIN_CURR_RECEPTOR || receptor_type >= SUP_CURR_RECEPTOR )
  {
    if ( receptor_type >= 0 && receptor_type < MIN_CURR_RECEPTOR )
...
inline
nest::port mynest::izhik_cond_exp::handles_test_event(nest::DataLoggingRequest& dlr,
