...
export NEST_MODELS_DIR="$4"/models/ #directory for of soruce code for models. Needed in Makefile.am
export NEST_LIBRANDOM_DIR="$4"/librandom/
...
$bootstrapDir"configure" --with-nest="${NEST_INSTALL_DIR}/bin/nest-config" 2>&1 | tee $logDir$1-$2-configure
